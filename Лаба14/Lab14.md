...
![рис.1 calculate.h](screen/1.jpg)

![рис.2 main.c](screen/2.jpg)

![рис.3 calculate.c](screen/3.jpg)

![рис.4 calculate.c (продолжение)](screen/4.jpg)
...
![рис.5 gcc(1)](screen/5.jpg)

![рис.6 gcc(2)](screen/6.jpg)

![рис.7 gcc(3)](screen/7.jpg)

Как можно заметить, синтаксические ошибки присуствовали, но мы их успешно исправили

- - -

**3.** Создали Makefile при помощи команды touchсо следующим содержанием:

![рис.8 Makefile](screen/8.jpg)
...
–	Для постраничного просмотра исходного кода использовал команду list

–	Для просмотра строк с 12 по 15 основного файла использовали list с параметрами

–	Для просмотра определённых строк не основного файла использовали list с параметрами – Установили точку останова в файле calculate.c на строке номер 21

![рис.9 терминал(1)](screen/9.jpg)
...
–	Посмотрели, чему равно на этом этапе значение переменной Numeral, введя: print Numeral

–	Сравнили с результатом вывода на экран после использования команды: display Numeral

–	Убрали точки останова

![рис.10 терминал(2)](screen/10.jpg)


**4.** При помощи команды splint, проанализировали коды файлов calculate.c, main.c

![рис.11 сплинт](screen/11.jpg)

![рис.12 терминал](screen/12.jpg)
